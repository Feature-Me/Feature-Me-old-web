...
# パッチノート
## 00100-beta(Version 0.6.0)
サーバーアップデート

サーバーヘルスチェック追加


## 00078-beta(Version 0.5.9)
Quick Menu のクイックジャンプ先URLを修正
...
楽曲セレクターのタイトルがオーバーフロー時に正しく省略されるように変更

Commit C:

ルーター更新

ページを開いた時のシーンチェンジャーの挙動を変更

+ ブラウザ起動後の初回起動時にスプラッシュスクリーンを表示するように変更
+ 起動時のシーン遷移アニメーションが削除

スプラッシュスクリーン用のテキストと画像を追加
