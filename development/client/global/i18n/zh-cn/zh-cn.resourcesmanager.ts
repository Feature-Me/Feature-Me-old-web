const ZHCNResourcesManagerTranslation = {
    "resources": {
        "notifications": {
            "downloading": "正在下载资源...",
            ...
            "model": {
                ...
                "errorExtracting": "提取模型失败。",
            },
            "music":{
                "downloading": "正在下载音乐...",
                "downloadingFailed": "下载音乐失败。",
                "noupdate": "没有音乐更新。请享受！",
                "updated": "成功更新音乐。",
                "errorSaving": "保存音乐失败。",
                "noFileMap": "没有找到音乐文件映射。",
                "errorExtracting": "提取音乐失败。",
            }
        }
    },
    "database": {
...
export default ZHCNResourcesManagerTranslation