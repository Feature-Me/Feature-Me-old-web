...
export class GLTFLoader extends Loader {
    ...
    loadFromBase64(base64: string, onLoad: (gltf: GLTF) => void, onProgress?: (event: ProgressEvent) => void, onError?: (event: ErrorEvent) => void): void;

    //added loadFromBase64Async
    loadFromBase64Async(base64: string): Promise<GLTF>;

    //added loadFromArrayBuffer
    loadFromArrayBuffer(buffer: ArrayBuffer, onLoad: (gltf: GLTF) => void, onProgress?: (event: ProgressEvent) => void, onError?: (event: ErrorEvent) => void): void;

    //added loadFromArrayBufferAsync
    loadFromArrayBufferAsync(buffer: ArrayBuffer): Promise<GLTF>;
