...
declare namespace Proton {
    ...
    class Alpha {
        ...
        //modified parameter b, c, life and easing to optional. make sure to use the correct type and allow Span.
    ...
    class Color {
        //modified parameter e, i, a to optional. make sure to use the correct type.
        constructor(t: string | string[], e?: string | string[], i?: number, a?: string | Function);
    ...
    class Emitter extends Particle {
        ...
        //modified parameter conf to optional
         ...
         */
        addBehaviour(...args: Array<Behaviour | Alpha | Attraction | Collision | Color | CrossZone | Force | Gravity | GravityWell | RandomDrift | Repulsion | Rotate | Scale>): void;
        ...
        //modified parameter emitTime and life to optional.
    ...
    class Force {
        //modified parameter i and a to optional. make sure to use the correct type
        constructor(t: number, e: number, i?: number, a?: string | Function);
    ...
    class Gravity extends Force {
        ...
        //modified parameter e, i and a to optional. make sure to use the correct type
        constructor(t: number, e?: number, i?: string | Function);
    ...
    class GravityWell extends Behaviour {
        ...
        //modified parameter e, i and a to optional. make sure to use the correct type
        constructor(t?: Vector2D, e?: number, i?: number, a?: string | Function);
    ...
    class Life extends Initialize {
        //modified parameter e and i to optional. make sure to use the correct type
        constructor(t: number, e?: number, i?: boolean);
    ...
    class Mass extends Initialize {
        ...
        //modified parameter b and c to optional. make sure to use the correct type
    ...
    class Radius extends Initialize {
        ...
        name: "Radius";
        //modified parameter e and i to optional. make sure to use the correct type
        constructor(t: any, e?: number, i?: boolean);
    ...
    class Scale extends Behaviour {
        ...
        //modified parameter i and a to optional. make sure to use the correct type
        constructor(t: number, e: number, i?: string, a?: string | Function);
