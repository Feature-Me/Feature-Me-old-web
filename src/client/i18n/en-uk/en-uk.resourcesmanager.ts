const ENUKResourcesManagerTranslation = {
    "resources": {
        "notifications": {
            ...
            "model": {
                ...
                "errorExtracting": "Failed to extract model.",
            },
            "music":{
                "downloading": "Downloading music...",
                "downloadingFailed": "Failed to download music.",
                "noupdate": "There is no music updates. Please enjoy!",
                "updated": "Successfully updated music.",
                "errorSaving": "Failed to save music.",
                "noFileMap": "File map not found.",
                "errorExtracting": "Failed to extract music.",
            }
        }
    },
    "database": {
...
export default ENUKResourcesManagerTranslation