const ENUKSettingsPage = {
    ...
    "graphics":{
        ...
        "gameAntiAliasing": {
            ...
            "description": "Set Anti-Aliasing behaviour of game rendering."
        },
        "gameAASampling": {
        ...
        "gameRenderType": {
            ...
            "description": "Set rendering behaviour of music game."
        },
        "gameFps": {
            "name": "FPS limit",
...
export default ENUKSettingsPage;